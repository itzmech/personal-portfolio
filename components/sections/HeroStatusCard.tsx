 ...
 * Static markup; glass surface tinted to match the night-city haze.
 */
export default function HeroStatusCard() {
  return (
    <div className="terminal-card overflow-hidden font-mono text-sm shadow-2xl">
      <div className="flex items-center justify-between border-b border-[#2b3442] px-5 py-3.5">
        <p>
      ...
      <div className="space-y-5 px-5 py-5">
        <div className="space-y-1.5">
          ...
          <p className="text-foreground">Ansh — CS Student &amp; Developer</p>
        </div>
        ...
        <p className="border-t border-[#2b3442] pt-4 text-success">
